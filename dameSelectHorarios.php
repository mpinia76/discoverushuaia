...
if (($_POST['HoraRetiroRecibida']!='')) {

	$HoraRetiro=$_POST['HoraRetiroRecibida'];
...
if (($_POST['HoraDevolucionRecibida']!='')) {

	$HoraDevolucion=$_POST['HoraDevolucionRecibida'];
...
$html=utf8_encode(HORA_RETIRO).'<br><select name="HoraRetiro" id="HoraRetiro" required style="width:150px" onChange="igualarDevolucion();dameSelectCategorias()">';
...
$html=utf8_encode(HORA_DEVOLUCION).'<br>

<select name="HoraDevolucion" id="HoraDevolucion" required style="width:150px" onChange="dameSelectCategorias()">';
