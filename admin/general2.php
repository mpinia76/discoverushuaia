...
@session_start();
 ...
 elseif($_SESSION['admin']!='si'){header("location:general.php");}
 else{
	 ?>
...
<div id="main_container">
    ...
    <div class="right_header">Bienvenido <?php echo $_SESSION['nombre']?> | <a href="#" class="messages">() Mensajes</a> | <a href="logout.php" class="logout">Logout</a></div>
    </div>
