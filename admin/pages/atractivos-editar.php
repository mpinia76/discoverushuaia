...
if ($_POST["borrar"]!="")
{
	...
	$laSQL = "DELETE from atractivos where Id='$borrar'";
...
<table width="100%" id="rounded-corner" >
    <thead>
    	<tr>
        	...
        	<?php
			$laSQL = "SELECT * FROM atractivos   order by orden";
			$result = mysqli_query($link,$laSQL)  ;
            ...
            <td>$Nombre</td>
            <td>$orden</td>
             <td><a href='".$dir_raiz."atractivos/edit-$Id.html'><img src='".$dir_raiz."images/user_edit.png'  border='0' /></a></td>
            <td><form method='post'>
