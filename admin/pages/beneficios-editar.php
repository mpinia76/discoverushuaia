...
if ($_POST["borrar"]!="")
{
	...
	$laSQL = "DELETE from beneficios where Id='$borrar'";
...
<table width="100%" id="rounded-corner" >
    <thead>
    	<tr>
        	...
        	<?php
			$laSQL = "SELECT * FROM beneficios  order by orden";
			$result = mysqli_query($link,$laSQL)  ;
            ...
            <td>$Nombre ($Marca)</td>
            <td>$orden</td>
             <td><a href='".$dir_raiz."beneficios/edit-$Id.html'><img src='".$dir_raiz."images/user_edit.png'  border='0' /></a></td>
            <td><form method='post'>
