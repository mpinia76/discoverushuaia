...
<table width="100%" id="rounded-corner" >
    <thead>
    	<tr>
        	...
        	<?php
			$laSQL = "SELECT * FROM sliderhome where Ubicacion='homeup' order by Id desc";
			$result = mysqli_query($link,$laSQL);			 
            ...
            <td>$Titulo</td>
             <td><a href='".$dir_raiz."sliderhome/edit-$Id.html'><img src='".$dir_raiz."images/user_edit.png'  border='0' /></a></td>
            <td><form method='post'>
