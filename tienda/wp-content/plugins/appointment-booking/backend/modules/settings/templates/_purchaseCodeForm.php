...
<form enctype="multipart/form-data" method="post" action="<?php echo esc_url( add_query_arg( 'tab', 'purchase_code' ) ) ?>" class="ab-settings-form" id="purchase_code">
    ...
    <div class="form-group">
        ...
        <input id="ab_envato_purchase_code" class="purchase-code form-control" type="text" name="purchase_code[bookly]" value="<?php echo get_option( \Bookly\Lib\Plugin::PURCHASE_CODE ) ?>" />
    </div>
