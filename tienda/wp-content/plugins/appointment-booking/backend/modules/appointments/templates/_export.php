    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="checkbox"><label><input checked value="<?php _e( 'Status', 'bookly' ) ?>" name="app_exp[appointment_status]" type="checkbox"><?php _e( 'Status', 'bookly' ) ?></label></div>
                <div class="checkbox"><label><input checked value="<?php _e( 'Payment', 'bookly' ) ?>" name="app_exp[total]" type="checkbox"><?php _e( 'Payment', 'bookly' ) ?></label></div>
