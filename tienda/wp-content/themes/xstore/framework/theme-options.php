...
if(!function_exists('etheme_redux_init')) {
    function etheme_redux_init() {
        ...
        Redux::setSection( $opt_name, array(
            'title' => 'Footer - W-P-L-O-C-K-E-R-.-C-O-M',
            'id' => 'general-footer',
            'subsection' => true,
            'icon' => 'el-icon-cog',
            'fields' => array (
            ...
            Redux::setSection( $opt_name, array(
                ...
                'fields' => array (
                    ...
                    array (
                        ...
                        'default' => false,
                        'required' => array(
                            array('single_layout','equals', array('small', 'default', 'xsmall', 'large', 'wide')),
                        )
                    ),
                    array (
                        'id' => 'fixed_content',
