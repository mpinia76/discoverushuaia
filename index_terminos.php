...
<head>
	...
	<title>Discover Ushuaia &#8211; Rent a Car</title>
...
background: #428BCA;
  ...
  <a href="#modal">HacÃ© tu reserva</a>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="2"><h3>Retiro</h3></td>
    </tr>
  <tr>
    <td width="40%" align="right">Lugar de retiro:</td>
  ...
  <tr>
    <td align="right">DÃ­a retiro</td>
    <td><input name="retiro" type="text" required id="retiro2" placeholder="ELEGIR"  ></td>
  </tr>
  <tr>
    <td align="right">Hora retiro</td>
...
?>
  ...
  <tr>
    <td colspan="2"><h3>DevoluciÃ³n</h3></td>
    </tr>
  <tr>
    <td align="right">Lugar de devolucion: </td>
...
echo "<option value='$Id'>$Nombre</option>";
  ...
  <tr>
    <td align="right">DÃ­a devoluciÃ³n</td>
    <td><input name="devolucion" placeholder="ELEGIR" type="text"  id="devolucion2"></td>
  </tr>
  <tr>
    <td align="right">Hora devoluciÃ³n</td>
...
?>
    ...
    <input type="submit" name="submit" id="submit" value="Seguir" class="btn medium black" style=" width:80%">
...
<li id="menu-item-4435" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-4435 item-level-0 item-design-dropdown columns-2"><a href="beneficios.html" class="item-link">'.utf8_encode(BENEFICIOS).'</a></li>
<li id="menu-item-4289" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-4289 item-level-0 item-design-dropdown columns-2"><a href="contacto-alquiler-de-autos-en-ushuaia.html" class="item-link">'.utf8_encode(CONTACTO).'</a></li>';
if ($_SESSION['idioma']=='es') {
	...
	if ($rowL = mysqli_fetch_array($result)) {
		...
		if ($rowL['valor']==1) {
			$botonera.='<li id="menu-item-4289" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-4289 item-level-0 item-design-dropdown columns-2" style="background-color: white;"><a href="reserva-alquiler-de-autos-en-ushuaia.html" class="item-link" style="color:#041e35;">Reservas On Line</a></li>';
		}
...
<div class="fixed-header header-color-dark"><div class="container"><div class="header-logo"><a href="index.html">
<img src="img/logo_blanco.png" alt="Rent a Car" width="200" height="61" class="logo-fixed" /></a> </div><div class="menu-wrapper menu-align-left" style="width:70%"><?=$botonera?></div></div>
<style>
...
echo "<option value='$Id'>$Nombre</option>";
            ...
            </td><td width="12%" align="left" valign="middle">DÃ­a retiro<br><input name="retiro" type="text" required id="retiro" placeholder="ELEGIR" onBlur="devolucion2();" onChange="dameSelectHorariosIndex();"><br>
            <div class="devolucion">
            DÃ­a devoluciÃ³n<br>
            <input name="devolucion" placeholder="ELEGIR" type="text"  id="devolucion" required onChange="dameSelectHorariosIndex();">
            </div>

            </td><td width="12%" align="left" valign="middle">Hora retiro<br>
            <span id="selectHoraRetiro"><select name="HoraRetiro" id="HoraRetiro" required onChange="devolucion2()" style="width:150px"><option value="" disabled selected>ELEGIR</option>
...
?></select></span><br>
            ...
            <div class="devolucion">
            Hora devoluciÃ³n<br>
            <span id="selectHoraDevolucion"><select name="HoraDevolucion" id="HoraDevolucion" required style="width:150px"><option value="" disabled selected>ELEGIR</option>
<? /*$start = "08:30";
$end = "22:00";
...
<div class="template-container">
		...
		<div class="container">
			<div class="navbar-collapse"><?=$botonera?></div><!-- /.navbar-collapse -->
		</div>
	</div>
...
<div class="header-wrapper header-xstore header-color-white">
        ...
        <div class="container">
            <div class="container-wrapper">
                ...
                <div class="menu-wrapper menu-align-center"><?=$botonera?></div>
...
<footer class="footer text-color-light">
        ...
        <div class="row">
            ...
            <div class="footer-widgets col-md-6 footer-widgets col-md-6 text-right">
                <ul>
                    <li>AtenciÃ³n al Cliente: <mark>(54) 11 52547702  (CABA) // (54) 2901 425337 (USHUAIA)</mark></li>
